          ...
          <nav className='fixed bottom-2 lg:bottom-8 w-full overflow-hidden z-50'>
            <div className='container mx-auto'>
              <div className='w-full bg-black/20 h-[96px] backdrop-blur-2xl rounded-full 
                      ...
                      <Link to='home' activeClass='active' smooth  spy title="Home" className='cursor-pointer w-[60px] h-[60px] flex items-center justify-center link-text'><AiOutlineHome/></Link>    
